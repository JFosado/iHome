...
export default {
  ...
  methods: {
    fetchData() {
      fetch(
        "http://192.168.0.128:3000/consults/bathroom1/presence"
      )
    ...
    fetchDoorStatus() {
      fetch("http://192.168.0.128:3000/consults/bathroom1/window")
        .then((response) => response.json())
        .then((data) => {
    ...
    fetchLightStatus() {
      fetch("http://192.168.0.128:3000/consults/bathroom1/internal-light")
        .then((response) => response.json())
        .then((data) => {
