...
fetchWindowStatus(){
  fetch("https://back-integradora-production.up.railway.app/consults/room2/window")
    .then((response) => response.json())
    .then((data) => {
...
fetchFanStatus(){
  fetch("https://back-integradora-production.up.railway.app/consults/room2/fan")
    .then((response) => response.json())
    .then((data) => {
...
fetchDoorStatus(){
  fetch("https://back-integradora-production.up.railway.app/consults/room2/door")
    .then((response) => response.json())
    .then((data) => {
...
fetchLightStatus(){
  fetch("https://back-integradora-production.up.railway.app/consults/room2/internal-light")
    .then((response) => response.json())
    .then((data) => {
